              ...
              <!-- <div class="widget">
                ...
                <div class="widget-body">
                  <div class="widget-text clearfix">
                    <img src="<?php bloginfo('template_directory');?>/images/user-avatar.png" alt="" width="70" class="img-circle left img-left">
      ...
      <footer class="page-section bg-gray-lighter footer pb-60">
        <div class="container">
          ...
          <div class="local-scroll mb-30 wow fadeInUp" data-wow-duration="1.5s">
            <a href="#top">
              <img src="<?php bloginfo('template_directory');?>/images/logo-footer.png" width="78" height="36" alt="" />
            </a>
          </div>
          <!-- End Footer Logo -->
