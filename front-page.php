    ...
    <div class="container relative">
        ...
        <div class="row">
            ...
            <div class="col-sm-6 banner-image wow fadeInUp">
                <img src="<?php bloginfo('template_directory');?>/images/promo-1.png" alt="" />
            </div>
            ...
            <div class="col-md-7 mb-sm-40">
                ...
                <div class="work-full-media mt-0 white-shadow wow fadeInUp">
                    <ul class="clearlist work-full-slider owl-carousel">
                        <li>
                            <img src="<?php bloginfo('template_directory');?>/images/promo-3.png" alt="" />
                        </li>
                        <li>
                            <img src="<?php bloginfo('template_directory');?>/images/portfolio/full-project-2.jpg" alt="" />
                        </li>
                    </ul>
                </div>
                <!-- End Gallery -->
        ...
        <div class="row">
            ...
            <div class="col-md-7 col-lg-offset-1">
                ...
                <div class="work-full-media mt-0 white-shadow wow fadeInUp">
                    <ul class="clearlist work-full-slider owl-carousel">
                        <li>
                            <img src="<?php bloginfo('template_directory');?>/images/promo-4.png" alt="" />
                        </li>
                        <li>
                            <img src="<?php bloginfo('template_directory');?>/images/portfolio/full-project-4.jpg" alt="" />
                        </li>
                    </ul>
                </div>
                <!-- End Work Gallery -->
